...
import com.example.dabbaWalaWebsite.models.AdminModel;
...
class MainController{
    ...
    public String saveCustomer(@ModelAttribute("customerModel") @Valid CustomerModel customerModel, BindingResult bindingResult,Model model){
        ...
        if(isUserSaved){
//            CustomerModel newCustomerModel = customerService.getCustomerByUsername(customerModel.getUsername());
//            model.addAttribute("customerId",newCustomerModel.getCustomerId());
            return "customerLogin";
        }
        return "customerRegister";
    }
...
//            RestaurantOwnerModel newRestaurantOwnerModel = restaurantOwnerService.getRestaurantByUsername(restaurantOwnerModel.getUsername());
//            model.addAttribute("restaurantOwnerId",newRestaurantOwnerModel.getOwnerId());
            //model.addAttribute("restaurantOwnerId",1);
