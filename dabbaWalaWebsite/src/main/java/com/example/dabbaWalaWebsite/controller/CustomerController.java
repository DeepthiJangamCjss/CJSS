...
//    }
    ...
    public String placeOrder(@RequestParam("customerId") int customerId,@RequestParam("restaurantId") int restaurantId,
                             @RequestParam("recipeId") int recipeId,@RequestParam("locationId") int locationId,Model model) {
        double afterDiscountPrice=customerService.getPriceAfterDiscount(customerId,recipeId);
